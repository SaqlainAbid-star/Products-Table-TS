...
fetch(apiUrl)
    ...
    var dataArray = data.products.map(function (products) { return [products.id, products.title, products.price, products.brand, products.category]; });
    ...
    var headerLabels = ['ID', 'Title', 'Price', 'Brand', 'Category'];
